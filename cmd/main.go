...
import (
	...
	"github.com/dradenvandewind/extending-kubernetes-cninf.git/internal/controller"
...
func init() {
	...
	utilruntime.Must(mycninfv1apha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e4268893.test.erwanleblond.com",
